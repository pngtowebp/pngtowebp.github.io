// CSV to Excel Converter - Client-Side Implementation
...
;(() => {
  ...
  async function handleConversion() {
    ...
    convertBtn.textContent = "GENERATING XLSX..."
    ...
    showNotification("Spreadsheets generated!", "success")
